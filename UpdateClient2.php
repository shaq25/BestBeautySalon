				...
				<div class="banner_content">
					<div class="row d-flex align-items-center">
						<div class="col-lg-7 col-md-12">
							<h1>Welcome to </h1> <br/>
							 <h2>The Best Beauty Salon Update Clients Page</h2> <br/>
                      <h3> Update Client TelePhone Number & EmailAddress</h3>
			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-6 offset-lg-6">
						<div class="contact-form-section" style="background-image:url(img/food/new9.jpg);">
							<h1 style="color:white" > Update Clients</h1>

							<h2 style="color:white" >Form</h2>
							<form class="contact-form-area contact-page-form contact-form text-right" action="UpdateclientP.php" method="post"
							 onSubmit="return confirm('Are you sure you want to update this Client') ">

								<div class="form-group col-md-12">
              <input type="text" class="form-control" id="name" minlength="9" maxlength="20" name="ClientID" placeholder="Enter your Client ID Shaqueal_Carroll" onfocus="this.placeholder = ''"
               onblur="this.placeholder = 'ClientID'" required=""
							 required placeholder="Enter Name"
			 				oninvalid="this.setCustomValidity('Enter ClientID Shaqueal_Carroll')"
			 				oninput="this.setCustomValidity('')" >
            </div>

						<div class="form-group col-md-12">
					<input type="text" class="form-control" id="name" name="Telephone" maxlength="12" minlength="12" placeholder="Please enter your 246-820-4563" onfocus="this.placeholder = ''"
					 onblur="this.placeholder = 'Please enter your 246-820-4563'" required=""
					 required placeholder="Enter Name"
							oninvalid="this.setCustomValidity('Enter Your Telephone Number Here 246-820-4563')"
						oninput="this.setCustomValidity('')" > >
				</div>

				<div class="form-group col-md-12">
			<input type="text" class="form-control" id="name" minlength="10"  maxlength="25"name="EmailAddress" placeholder="Please enter your Jonedoe@gmail.com" onfocus="this.placeholder = ''"
