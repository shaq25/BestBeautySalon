...
<title>The Best Beauty Salon Delete Invoice</title>
	<!-- Bootstrap CSS -->
				...
				<div class="banner_content">
					<div class="row d-flex align-items-center">
						<div class="col-lg-7 col-md-12">
							<center><h1> Delete Invoice </h1></center>
							...
							<center>	<form method="Post" action="DeleteinvoiceP.php"  onSubmit="return confirm('Are you sure you want to delete this Invoice ?') ">

							<select class="delete" name='InvoiceNum'>
							              <?php
							              ...
							              $result = mysqli_query($conn, "SELECT InvoiceNum FROM invoice");
