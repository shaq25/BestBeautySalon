...
<body id="book-table">
			...
			<div class="navbar">
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link" href="home.php"><img src="img/banner/curl.png"style="width:50px;150px;" alt=""> home</a></li>
						...
						<li class="nav-item"><a class="nav-link" href="viewService.php"><img src="img/banner/client.png"style="width:50px;150px;" alt="">View Service</a></li>
					<li class="nav-item"><a class="nav-link" href="deleteService.php"><img src="img/banner/delete.png"style="width:50px;150px;" alt="">Delete Service</a></li>
	...
	<div class="site-main">
		...
		<section class="home_banner_area common-banner">
			<div class="banner_inner" style="background-image:url(img/banner/22.jpg); background-repeat:no-repeat: cover; background-size: 100% 100%; ">
					...
					<div class="row d-flex align-items-center">
						<div class="col-lg-7 col-md-12">
							<h1>Welcome to </h1>
							 ...
							 <h2>The Best Beauty Salon Service Page</h2>
							 <h2>
							 <?php
							 			echo " ".$_SESSION['User'];
							  ?>
				...
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-6 offset-lg-6">
						<div class="contact-form-section" style="background-image:url(images/salon.jpg); background-size:100% 100%;">
							...
							<h2>Form</h2>
							<form class="contact-form-area contact-page-form contact-form text-right" action="ServiceP.php" method="post"  onSubmit="return confirm('Did you check to see if data was enter correctly ?') ">

								<div class="form-group col-md-12">
              <input type="number" class="form-control" id="name" maxlength="" name="ID" placeholder="Enter Service Number eg 01,02,03" onfocus="this.placeholder = ''"
               onblur="this.placeholder = 'Enter Service Number 01, 02, 03'" required=""
							 required placeholder="Enter Name"
								 oninvalid="this.setCustomValidity('Enter Service number 01, 02, 03 Here')"
						...
						<div class="form-group col-md-12">
					<input type="number" class="form-control" id="name" minlength="2" name="Price" placeholder="Enter Price $12.50" onfocus="this.placeholder = ''"
					 onblur="this.placeholder = 'Price'" required=""  required placeholder="Enter Name"
							 oninvalid="this.setCustomValidity('Enter Price 123 , 50 Here')"
						 oninput="this.setCustomValidity('')">
				</div>
				          	...
				          	<input type="Submit" name="" value="Submit" onclick="cal()">
