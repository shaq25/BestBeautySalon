...
<title>The Best Beauty Salon View Invoice</title>
	<!-- Bootstrap CSS -->
	...
	<link rel="stylesheet" href="css/style.css">
 	...
 	h1,h2{
	  ...
	  tr:nth-child(even){background-color:peachpuff;}
				...
				<div class="banner_content">
					<div class="row d-flex align-items-center">
						<div class="col-lg-7 col-md-12">
							<center><h1>Invoice table</h1></center>
										 ...
										 $result = mysqli_query($conn, "SELECT * FROM invoice ;");
											 ...
											 if ($result->num_rows > 0)
											{
												echo	"<table >";
													echo	"<tr>";
														echo"<th>#</th>";
														echo	"<th>InvoiceNum</th>";
													echo	"<th>Service</th>";
														echo "<th>PaymentMethod</th>";
														echo "<th>%_Discount_%</th>";
															echo"<th>Price_$</th>";
														echo"</tr>";
											...
											while($rows = $result -> fetch_assoc())
											{
												...
												if ($i < 5) {
													...
													echo$i ;
													echo" </td><td>";
													echo $rows["InvoiceNum"];
													echo "</td><td>";
													echo $rows["Service"];
													echo "</td><td>";
													echo	$rows["PaymentMethod"];
													echo "</td><td>";
													echo $rows["Discount"];
													echo "</td><td>";
													echo $rows["Price"];
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						<div class="single-footer-widget">
							...
							<div class="row">
								<div class="col">
									<ul class="list">
										<li><a href="#">TelePhone Number : (246)820-9882</a></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-2 col-md-4 col-sm-6">
						<div class="single-footer-widget">
							...
							<div class="row">
								<div class="col">
									<ul class="list">
										<li><a href="#">6TH Avenue Hasting Christ Church Barbados</a></li>
