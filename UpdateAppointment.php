...
<body id="book-table">
	...
	<div class="site-main">
		...
		<form method="Post" action="UpdateappointmentP.php"  onSubmit="return confirm('Are you sure you want Update this Appointment?') ">
					<select name='Orders'>
					 <?php
					 ...
					 $result = mysqli_query($conn, "SELECT ClientID FROM appointment WHERE Status='Incomplete'");
...
?>
  ...
  <input type="Submit" value="UPDATE" name="complete" > <br>
