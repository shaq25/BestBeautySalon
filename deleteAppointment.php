...
<title>The Best Beauty Salon </title>	<!-- Bootstrap CSS -->
				...
				<div class="banner_content">
					<div class="row d-flex align-items-center">
						<div class="col-lg-7 col-md-12">
							<center><h1> Delete Appointment </h1></center>
							...
							<center>	<form method="Post" action="DeleteappointmentP.php"  onSubmit="return confirm('Are you sure you want to delete this Appointment ?') ">

							<select class="delete" name='AppointmentID'>
							              <?php
							              ...
							              $result = mysqli_query($conn, "SELECT AppointmentID FROM appointment");
