				...
				<div class="banner_content">
					<div class="row d-flex align-items-center">
						<div class="col-lg-7 col-md-12">
							<center><h1> Delete Service </h1></center>
							...
							<center>	<form method="Post" action="DeleteserviceP.php"  onSubmit="return confirm('Are you sure you want to delete this Service ?') " >

							<select class="delete" name='ServiceID'>
							              <?php
							              ...
							              $result = mysqli_query($conn, "SELECT ServiceID FROM service");
